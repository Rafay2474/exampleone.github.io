    ...
    public function import_files_config() {
        ...
        $home_prevs = [
            'fastpro_home_1' => [
                ...
                'screenshot'   => plugins_url( 'assets/preview/home1.png', dirname( __FILE__ ) ),
                'preview_link' => 'https://www.devsnews.com/wp/markite/',
            ],
            'fastpro_home_2' => [
                'title'        => __( 'Home 2', 'bdevs-toolkit' ),
                'page'         => __( 'home-02', 'bdevs-toolkit' ),
                'screenshot'   => plugins_url( 'assets/preview/home2.png', dirname( __FILE__ ) ),
                'preview_link' => 'https://www.devsnews.com/wp/markite/home-02/',
            ],
            'fastpro_home_3' => [
                ...
                'preview_link' => 'https://www.devsnews.com/wp/markite/home-03/',
            ]
        ];

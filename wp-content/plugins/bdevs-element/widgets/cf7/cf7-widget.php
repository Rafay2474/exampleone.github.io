    ...
    protected function register_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'placeholder' => __('CTA info Text', 'bdevs-element'),
                'dynamic' => [
                    'active' => true,
                ],
                'condition' => [
           ...
           <div class="container">
              <div class="row">
                 <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                    <div class="contact__wrapper white-bg mt--70 p-relative z-index-1 wow fadeInUp2" data-wow-delay=".3s">
                       <div class="row">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="subscribe__wrapper d-xl-flex justify-content-between align-items-center wow fadeInUp2" data-wow-delay=".5s">
                        <div class="subscribe__content">
                            <?php if ($settings['title']) : ?>
                                <h3 class="subscribe__title"><?php echo bdevs_element_kses_intermediate($settings['title']); ?></h3>
                            <?php endif; ?>
                        ...
                        <div class="subscribe__form text-start text-lg-end">
                            <?php if (!empty($settings['form_id'])) {
                                echo bdevs_element_do_shortcode('contact-form-7', [
                                    'id' => $settings['form_id'],
                                    'html_class' => 'bdevs-cf7-form ' . bdevs_element_sanitize_html_class_param($settings['html_class']),
    ...
    <?php else:
        ...
        <section class="contact__area pt-105 pb-145">
            ...
            <div class="contact__shape">
               <img class="man-1" src="<?php echo esc_url($shape_image); ?>" alt="img">
